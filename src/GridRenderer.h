...
struct SGridFrameData
{
    ...
    // Во fragment shader используется для восстановления eye-space луча текущего пикселя из gl_FragCoord.
...
// Готовые шаги сетки, рассчитанные на C++ стороне.
...
// Основная логика находится во fragment shader:
...
private:
    // Возвращает согласованные minor/major шаги.
    //
    // Major step не хранится отдельно, а всегда вычисляется как:
